...
import oscarblancarte.ipd.templetemethod.impl.ProcesarArchivoCargos;
...
public class TempleteMethodMain extends TimerTask {
    ...
    private static final String[] PATHS = 
        new String[]{"C:/TEMP/files/drugstore", "C:/TEMP/files/grocery", "C:/TEMP/files/cargos"};
    private static final String LOG_DIR = "C:/TEMP/files/logs";
    private static final String PROCESS_DIR = "C:/TEMP/files/process";
    ...
    public void run() {
        ...
        System.out.println("> Read Path " + PATHS[1]);
        File[] cargosFiles = f.listFiles();
        for (File file : cargosFiles) {
            try {
                System.out.println("> File found > " + file.getName());
                new ProcesarArchivoCargos(file,LOG_DIR,PROCESS_DIR).execute();
                System.out.println("Processed file > " + file.getName());
            } catch (Exception e) {
                System.err.println(e.getMessage());
            }
